...
from hakura.views import welcome,userdetails,allusers,createuser,createpost,logoutuser,updateprofile, followuser,debug_followers, unfollowuser
...
urlpatterns = [
    ...
    path('unfollowuser/<id>', unfollowuser),
